...
Apply all 15 core guardrails and formatting standards to every question generate in this batch:
...
2. BLANK MARKERS FOR CONSTRUCTED RESPONSE & DROPDOWN
   ...
   - CONSTRUCT PURITY: In multi-blank items, every blank must directly assess the targeted learning objective. Never insert filler blanks, prerequisite guessing steps, or blanks that require unstated outside knowledge.
