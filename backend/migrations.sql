...
CREATE TABLE IF NOT EXISTS questions (
  ...
  user_id      INTEGER REFERENCES users(id) ON DELETE CASCADE,
  type         VARCHAR(30) NOT NULL CHECK (type IN ('SINGLE_SELECT', 'MULTIPLE_SELECT', 'MCQ', 'TRUE_FALSE', 'SHORT_ANSWER', 'FILL_IN_BLANK', 'CONSTRUCTED_RESPONSE', 'DROPDOWN', 'MATCHING_LINES', 'ORDERING', 'BACKGROUND_GRAPHIC', 'GAP_MATCH', 'MULTIPLE_DROP_BUCKET', 'MATRIX_INTERACTION')),
  text         TEXT NOT NULL,
  options      JSONB,
