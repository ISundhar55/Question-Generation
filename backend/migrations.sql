...
CREATE TABLE IF NOT EXISTS questions (
  ...
  user_id      INTEGER REFERENCES users(id) ON DELETE CASCADE,
  type         VARCHAR(30) NOT NULL CHECK (type IN ('SINGLE_SELECT', 'MULTIPLE_SELECT', 'MCQ', 'TRUE_FALSE', 'SHORT_ANSWER', 'FILL_IN_BLANK', 'CONSTRUCTED_RESPONSE', 'DROPDOWN', 'MATCHING_LINES', 'ORDERING')),
  text         TEXT NOT NULL,
  options      JSONB,
