  ...
  return (
    <div className="qc-field">
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginTop: 12 }}>
          ...
          {options.map((opt, i) => (
            ...
            >
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', width: 22, textAlign: 'center', flexShrink: 0 }}>
                  {i + 1}.
                </span>
                <input
                  className="qc-input"
        ...
        <div>
          <label className="qc-label" style={{ marginBottom: 12 }}>Teacher's Correct Sequence (Drag to Reorder)</label>
          <div style={{
